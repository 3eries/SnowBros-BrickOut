...
void PluginManager::initAds(const rapidjson::Value &obj) {
    ...
    if( adsConfig.testMode ) {
        ...
        adsConfig.bannerUnitId = obj["banner_unit_id"].GetString();
        adsConfig.interstitialUnitId = obj["interstitial_unit_id"].GetString();
        adsConfig.rewardedVideoUnitId = obj["rewarded_video_unit_id"].GetString();
    }
